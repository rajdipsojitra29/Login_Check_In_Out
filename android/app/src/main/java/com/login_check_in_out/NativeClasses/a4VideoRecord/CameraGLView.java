...
import com.login_check_in_out.NativeClasses.a4VideoRecord.glutilsOld.GLDrawer2D;
...
//					}
					...
					Log.i(TAG, String.format("fps:%d-%d", max_fps[0], max_fps[1])); //fps:30000-30000
//					params.setPreviewFpsRange(max_fps[0], max_fps[1]);
//					params.setPreviewFrameRate(29);
...
//							parent.setVideoSize(previewSize.width, previewSize.height);
							parent.setVideoSize(640, 360);
//							parent.setVideoSize(360, 640);
						}
					});
